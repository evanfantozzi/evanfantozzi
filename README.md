...
🏀 [**Parallelizing a Simulated Fantasy-style NBA Draft**](https://github.com/evanfantozzi/NBA-Draft-Simulator) – A simulation of a parallelized fantasy-style NBA draft. Built in **Go**, the simulator assigns players to teams using an evaluation system that continuously checks statistical and categorical needs, exporting full team depth charts and a draft summarie. The project includes two parallel and one sequential implementations of the simulation, exploring the benefit of multithreading in Go.
