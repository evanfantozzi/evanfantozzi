...
📺 [**Modeling Humor and Emotion in Scrubs**](https://github.com/evanfantozzi/Scrubs-Analysis) – Built an end-to-end NLP pipeline in **PyTorch** to analyze how humor and emotional intensity shape audience reactions to episodes of Scrubs. Scraped detailed fan-made transcripts and IMDb ratings, manually labeled scene-level data across 15 episodes, and trained a fine-tuned DeBERTa model alongside prompted Gemini 2.5 models to predict how funny and sad individual scenes are. Aggregated these predictions to the episode level and used them to model IMDb ratings, finding that emotional variance helps explain the variation in episode ratings.
